...
#include "XGRPGGameplayAbility_Death.generated.h"
...
UCLASS(Abstract)
class UXGRPGGameplayAbility_Death : public UXGRPGGameplayAbility
{
	GENERATED_BODY()
...
public:
	...
	UXGRPGGameplayAbility_Death(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
