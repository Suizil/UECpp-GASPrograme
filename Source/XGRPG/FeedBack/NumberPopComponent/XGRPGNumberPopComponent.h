...
#include "XGRPGNumberPopComponent.generated.h"
...
public:
	...
	UXGRPGNumberPopComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
