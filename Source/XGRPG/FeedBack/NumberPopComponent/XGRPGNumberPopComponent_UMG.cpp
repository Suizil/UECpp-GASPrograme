...
UXGRPGNumberPopComponent_UMG::UXGRPGNumberPopComponent_UMG(const FObjectInitializer& ObjectInitializer)
...
void UXGRPGNumberPopComponent_UMG::AddNumberPop(const FXGRPGNumberPopRequest& NewRequest)
{
	...
	{
		AXGRPGDamageNumActor* PopActor = LocalWorld->SpawnActor<AXGRPGDamageNumActor>(NumPopActorClass, NewRequest.WorldLocation, FRotator::ZeroRotator);
