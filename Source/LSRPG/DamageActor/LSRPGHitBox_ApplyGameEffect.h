...
#include "LSRPGHitBox_ApplyGameEffect.generated.h"
...
//这是一个定义碰撞类型的枚举
UENUM(BlueprintType)
enum class ELSRPGHitCollisionType :uint8
{
...
class LSRPG_API ALSRPGHitBox_ApplyGameEffect : public AActor
{
	GENERATED_BODY()
...
public:
	...
	ELSRPGHitCollisionType HitCollisionType;


public:
	// Sets default values for this actor's properties
	ALSRPGHitBox_ApplyGameEffect(const FObjectInitializer& ObjectInitializer);
	...
	//是否意见造成效果
	bool IsExist(ALSRPGCharacterBase* InNewTaget) const;
...
protected:
	...
	//储存我们的重叠目标
	UPROPERTY()
	TArray<TWeakObjectPtr<ALSRPGCharacterBase>> AttackedTarget;
