...
class ALSRPGHitBox_ApplyGameEffect;
/**
 *
 */
UCLASS(meta = (DisplayName = "ApplyGameplayEffect"))
class LSRPG_API UAnimNotify_ApplyGameplayEffect : public UAnimNotify
{
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "General Configuration")
	TSubclassOf<ALSRPGHitBox_ApplyGameEffect> HitObjectClass;
