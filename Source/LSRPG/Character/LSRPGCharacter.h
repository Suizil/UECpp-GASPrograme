...
#include "LSRPGCharacter.generated.h"
...
UCLASS(config=Game)
class LSRPG_API ALSRPGCharacter : public ALSRPGCharacterBase
{
	GENERATED_BODY()

public:

	ALSRPGCharacter(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
