...
#include "LSRPGNumberPopComponent.generated.h"
...
UCLASS(Abstract)
class ULSRPGNumberPopComponent : public UActorComponent
{
	GENERATED_BODY()
...
public:
	...
	ULSRPGNumberPopComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
