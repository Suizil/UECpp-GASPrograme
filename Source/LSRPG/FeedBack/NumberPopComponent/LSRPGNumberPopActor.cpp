...
ALSRPGDamageNumActor::ALSRPGDamageNumActor()
{
...
void ALSRPGDamageNumActor::UpdateNum(const FText& InText)
{
...
void ALSRPGDamageNumActor::UpdateNumColor(const FLinearColor& InColor)
{
	if (DamgeWidgetComponent)
	{
