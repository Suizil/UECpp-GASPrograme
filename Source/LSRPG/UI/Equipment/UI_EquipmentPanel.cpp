...
void UUI_EquipmentPanel::NativeConstruct()
{
	...
	{
		InCharacter->GetLSRPGEquipmentComponent()->OnEquipmentItemChanged.BindUObject(this, &UUI_EquipmentPanel::OnEquipmentItemChanged);
...
void UUI_EquipmentPanel::NativeDestruct()
{
	...
	if (ALSRPGCharacterBase* InCharacter = UI_GetLSRPGCharacterBase())
	{
		InCharacter->GetLSRPGEquipmentComponent()->OnEquipmentItemChanged.Unbind();

	}
}

void UUI_EquipmentPanel::OnEquipmentItemChanged(const TArray<FLSRPGEquipmentItem>& InEquipmentItems)
{
